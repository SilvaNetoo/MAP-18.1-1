 ...
 * 
 * @author Criada por Wesley Alves em 25 de fev de 2018
 */
public abstract class ContaBancaria {
	 ...
	 * @param valor
	 *            caso no ato da criação tenha já um depósito;
	 * @param cpf
	 *            identificador da conta;
	 * @throws ValorInvalidoException
	 *             caso o valor fornecido para deposíto no ato da criação seja
	 *             inválido.
	 */
	public ContaBancaria(int agencia, int conta, double valor, String cpf)
			throws ValorInvalidoException {
	 ...
	 */
	public abstract double deposito(double valor) throws ValorInvalidoException;

	/**
	 * 
	 * O método saque() deve ser responsável por realizar operação de retirada de
	 * dinheiro, o método encontra-se na classe ContaBancaria, tem como retorno um
	 * double, foi criado por Wesley ALves em 26 de fev de 2018;
	 *
	 * @param valor
	 ...
	 *             caso o valor seja inválido para a operação.
	 */
	public abstract double saque(double valor) throws ValorInvalidoException;
